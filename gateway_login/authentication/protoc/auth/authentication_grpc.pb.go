...
func (c *authClient) Authenticate(ctx context.Context, in *AuthReq, opts ...grpc.CallOption) (*AuthResp, error) {
	out := new(AuthResp)
...
func (UnimplementedAuthServer) Authenticate(context.Context, *AuthReq) (*AuthResp, error) {
